...
arguments
    ...
    opts.ExpectVersion (1,1) string  = "R4-5"
end
...
try
    ...
    if fwVersion ~= opts.ExpectVersion
        warning("STM32:FirmwareMismatch", ...
            ...
            "Rebuild and upload Control_System_lab_1 before trusting any\n" + ...
            "result. Symptoms of the old build: rxErr climbing, ERR=UNKNOWN\n" + ...
