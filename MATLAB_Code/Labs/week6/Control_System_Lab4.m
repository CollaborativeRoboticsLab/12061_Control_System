...
%
% In Session 3 you made the pendulum fall and measured how fast. Here you
% close the loop and shape its behaviour. Part A of the handout (poles,
...
%        "sim"  runs a model of it, no hardware needed
...
% Data lands next to THIS script, resolved from the script's own path, not
...
% Balance_Pwm is the angle PID you have been tuning. Position_Pwm is a PD
% on cart position whose gains are PKP and PKD. Subtracting it is what
